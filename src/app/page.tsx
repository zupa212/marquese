    ...
    <Layout>
      ...
      <Section id="services" rounded>
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-xl text-left">
            <span className="text-brand-gold font-serif text-lg italic tracking-widest uppercase">Premium Services</span>
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-brand-charcoal mt-2 mb-6">Experience the Best</h2>
      ...
      <Section dark id="signature" rounded>
        <div className="text-center mb-24">
          <span className="text-brand-gold font-serif text-lg italic tracking-widest uppercase mb-4 block underline underline-offset-8 decoration-brand-gold/20">The Art of Barbering</span>
          <h2 className="text-4xl md:text-6xl font-serif font-bold text-brand-ivory italic">Marquise Signature</h2>
        </div>
      ...
      <Section rounded>
        <div className="text-center mb-16">
          <span className="text-brand-gold font-serif text-lg italic tracking-widest uppercase">Atmosphere</span>
          <h2 className="text-4xl md:text-5xl font-serif font-bold text-brand-charcoal mt-2 mb-4">Inside the Shop</h2>
      ...
      <Section id="reviews" dark rounded className="mb-20">
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4 text-brand-ivory italic">Customer Excellence</h2>
          <div className="flex items-center space-x-2 mb-4">
            {[1, 2, 3, 4, 5].map(i => <Star key={i} size={20} className="fill-brand-gold text-brand-gold" />)}
          </div>
          <p className="text-brand-gold font-bold tracking-[0.3em] text-sm uppercase">Certified quality</p>
        </div>
      ...
      <Section id="location" rounded>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-10">
            <div>
              <span className="text-brand-green font-bold uppercase tracking-widest text-sm block mb-4">Visit Us</span>
              <h2 className="text-4xl md:text-6xl font-serif font-bold text-brand-charcoal mb-6 leading-tight">Your Premium <span className="text-brand-green italic">Destination</span></h2>
            ...
            <div className="space-y-8 bg-brand-green/5 p-10 rounded-[2.5rem] border border-brand-green/10">
              <div className="flex items-start space-x-5">
                ...
                <div>
                  <h4 className="font-bold uppercase tracking-widest text-xs mb-2 text-brand-green">Διεύθυνση</h4>
                  <p className="text-brand-charcoal text-xl font-serif italic">{BUSINESS_INFO.address}</p>
                  <a href={GOOGLE_MAPS_URL} target="_blank" className="text-brand-green text-sm font-bold hover:underline inline-block mt-2">Άνοιγμα Χαρτών →</a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-5">
                ...
                <div>
                  <h4 className="font-bold uppercase tracking-widest text-xs mb-2 text-brand-green">Τηλέφωνο</h4>
            ...
            >
              {BOOKING_URL ? "Book Your Appointment" : "Call for Appointment"}
            </Link>
          </div>
