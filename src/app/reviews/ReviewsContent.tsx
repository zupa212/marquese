            ...
            <Section rounded>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {reviews.map((review, i) => (
                        <div key={i} className="bg-white p-10 border border-brand-charcoal/5 rounded-[2rem] shadow-sm relative group hover:shadow-xl hover:border-brand-gold/30 transition-all duration-300">
