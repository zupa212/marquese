...
export const translations = {
    el: {
        ...
        homepage: {
            ...
            signatureShaveDesc: "Η ιεροτελεστία του ξυρίσματος με ζεστές πετσέτες, premium προϊόντα και την απόλυτη προσοχή στη λεπτομέρεια που μόνο ένας Marquise κουρέας μπορεί να προσφέρει.",
            signatureDetoxTitle: "Detox & Θεραπεία Τριχωτού",
            signatureDetoxDesc: "Βαθύς καθαρισμός και αναζωογόνηση για το τριχωτό της κεφαλής. Μια ολοκληρωμένη εμπειρία σπα που απομακρύνει τους ρύπους και δυναμώνει την τρίχα.",
            galleryLabel: "Ατμόσφαιρα",
            galleryTitle: "Μέσα στο Κουρείο μας",
            galleryDesc: "Στιγμές από την καθημερινότητά μας.",
            galleryCta: "Δείτε όλη τη γκαλερί",
            reviewsTitle: "Εμπιστοσύνη Πελατών",
            reviewsQuality: "Πιστοποιημένη ποιότητα",
            reviewsCta: "Διαβάστε όλες τις κριτικές",
            locationLabel: "Επισκεφθείτε μας",
            locationTitle: "Ο Premium",
            locationTitleHighlight: "Προορισμός σας",
            locationDesc: "Βρισκόμαστε στην καρδιά της Κηφισιάς, σε έναν χώρο σχεδιασμένο για την απόλυτη άνεση και χαλάρωση του άνδρα.",
            locationAddress: "Διεύθυνση",
            locationPhone: "Τηλέφωνο",
            locationMaps: "Άνοιγμα Χαρτών →",
            locationCta: "Κλείστε Ραντεβού",
        },
        common: {
    ...
    en: {
        ...
        homepage: {
            ...
            signatureTitle: "Marquise Signature",
            signatureShaveTitle: "Traditional Shave",
            signatureShaveDesc: "The ritual of shaving with hot towels, premium products, and the absolute attention to detail that only a Marquise barber can offer.",
            signatureDetoxTitle: "Detox & Scalp Therapy",
            signatureDetoxDesc: "Deep cleansing and rejuvenation for the scalp. A complete spa experience that removes impurities and strengthens hair.",
            galleryLabel: "Atmosphere",
            galleryTitle: "Inside Our Shop",
            galleryDesc: "Moments from our daily craft.",
            galleryCta: "View Full Gallery",
            reviewsTitle: "Customer Excellence",
            reviewsQuality: "Certified quality",
            reviewsCta: "Read All Reviews",
            locationLabel: "Visit Us",
            locationTitle: "Your Premium",
            locationTitleHighlight: "Destination",
            locationDesc: "Located in the heart of Kifisia, in a space designed for the ultimate comfort and relaxation of men.",
            locationAddress: "Address",
            locationPhone: "Phone",
            locationMaps: "Open Maps →",
            locationCta: "Book Appointment",
        },
        common: {
            visitUs: "Visit Us",
            phone: "Phone",
